...
# FILE = "/Users/jasonchen/Documents/CS Projects/Trading Bot/NASDAQ100Copy.csv"
# company_names = load_company_names(FILE)
# l = []
# for comp in company_names:
#     try:
#         company = Company(comp)
#         l.append(len(company.test_index_list))
#         print(comp, len(company.test_index_list))
#     except:
#         print("error")
...
# AAPL = Company("ABNB")
# indices = AAPL.test_index_list

# df = AAPL.stock_hist
# print(len(indices))
# print(df.iloc[-300]["Close"])
# # compute returns for all trading days in test set
# for index in indices[1:-1]:
#     trading_day_return = 0
#     b_h_day_return = 0
#     company_probs = {}  # dictionary tracking each company's probability of stock going up
